...
abstract class FoodLogRemoteDataSource {
  ...
  Future<List<FoodLogModel>> getDailyLogs(DateTime date);
...
class FoodLogRemoteDataSourceImpl implements FoodLogRemoteDataSource {
  ...
  @override
  Future<List<FoodLogModel>> getDailyLogs(DateTime date) async {
  ...
  Future<void> deleteFoodLog(String id) async {
    await client.from('food_logs').delete().eq('id', id);
  }
}
