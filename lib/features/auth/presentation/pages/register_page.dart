    ...
    ref.listen<AsyncValue<User?>>(authProvider, (previous, next) {
      next.whenOrNull(
        ...
        error: (error, stackTrace) {
          // Email verification required — navigate to confirmation screen.
          if (error is EmailConfirmationNeededException) {
            final email = _emailController.text.trim();
            context.go('/email-confirmation?email=$email');
            return;
          }
          final message = ErrorHandler.message(error);
          // Rate-limit errors are login-specific; hide from register screen.
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          ...
          const Expanded(
            child: _BrandedPanel(
              title: 'Join Bite Balance',
              subtitle: 'Start your healthy eating journey today',
            ),
          ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: const [
                      _FeatureChip(
                          icon: Icons.auto_awesome, label: 'AI Analysis'),
                      _FeatureChip(
